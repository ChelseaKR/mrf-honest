...
- [x] `dataset.csv` with a Frictionless Table Schema description
- [x] A static JSON API under the site, generated from the same comparison documents
- [x] Both regenerated by the render, never hand-maintained, and both checked on the deploy path
