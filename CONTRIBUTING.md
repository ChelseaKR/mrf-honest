...
passes locally, the pre-push hook (which runs the same commands) will pass too. `uv build` verifies
the wheel and source distribution, including the `mrf-honest` console entry point. Do not lower any
